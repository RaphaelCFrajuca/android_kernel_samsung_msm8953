...
#define CHG_FAULT_STATUS_MASK		MASK(CHG_FAULT_STATUS_WIDTH, CHG_FAULT_STATUS_SHIFT)
...
#define SET_CHG_2L_DROP_MASK		MASK(SET_CHG_2L_DROP_WIDTH, SET_CHG_2L_DROP_SHIFT)
#define SET_CHG_3L_DROP_SHIFT		6
#define SET_CHG_3L_DROP_WIDTH		2
#define SET_CHG_3L_DROP_MASK		MASK(SET_CHG_3L_DROP_WIDTH, SET_CHG_3L_DROP_SHIFT)
/* S2MU004_CHG_CTRL6 */
...
#define COOL_CHARGING_CURRENT_MASK	MASK(COOL_CHARGING_CURRENT_WIDTH, COOL_CHARGING_CURRENT_SHIFT)
/* S2MU004_CHG_CTRL9 */
#define FAST_CHARGING_CURRENT_SHIFT	0
#define FAST_CHARGING_CURRENT_WIDTH	7
#define FAST_CHARGING_CURRENT_MASK	MASK(FAST_CHARGING_CURRENT_WIDTH, FAST_CHARGING_CURRENT_SHIFT)
/* S2MU004_CHG_CTRL11 */
#define FIRST_TOPOFF_CURRENT_SHIFT	0
#define FIRST_TOPOFF_CURRENT_WIDTH	4
#define FIRST_TOPOFF_CURRENT_MASK	MASK(FIRST_TOPOFF_CURRENT_WIDTH, FIRST_TOPOFF_CURRENT_SHIFT)
#define SECOND_TOPOFF_CURRENT_SHIFT	4
#define SECOND_TOPOFF_CURRENT_WIDTH	4
#define SECOND_TOPOFF_CURRENT_MASK	MASK(SECOND_TOPOFF_CURRENT_WIDTH, SECOND_TOPOFF_CURRENT_SHIFT)
/* S2MU004_CHG_CTRL12 */
...
#define SET_OSC_BUCK_3L_MASK		MASK(SET_OSC_BUCK_3L_WIDTH, SET_OSC_BUCK_3L_SHIFT)
enum {
