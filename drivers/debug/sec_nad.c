				     ...
				     struct device_attribute *attr, char *buf)
{
		...
		//QNAD_1.0.1_SLT_22022018_SDM450 - Only QMESA_32
		return snprintf(buf, BUFF_SZ, "S450.0102.02.QMESA32\n");
	#else
		//QUEST_32bit_1.0.0_SS_05082018_SDM450 - official 32bit
		return snprintf(buf, BUFF_SZ, "S450.0103.03.32bit\n");
	#endif
}
